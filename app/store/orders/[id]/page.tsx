...
export default function StoreOrderDetailPage() {
  ...
  async function updateStatus(status: OrderStatus) {
    ...
    try { await mutateBackoffice(`/api/backoffice/orders/${encodeURIComponent(liveOrderId)}`, { status }); await refresh(); setMessage("Order and shipment workflow updated in Sanity."); }
