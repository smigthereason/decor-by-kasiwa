      ...
      <section className="flex min-h-[calc(100vh-140px)] w-full flex-col bg-[var(--paper)]">
        <div className="flex flex-1 items-center justify-center px-4 py-20">
          <div className="text-center">
            ...
            <Link
              href="/shop"
              className="group mt-8 inline-flex items-center gap-2 rounded-full bg-[var(--ink)] px-6 py-3.5 text-[10px] font-semibold uppercase tracking-[0.08em] !text-white transition-all hover:gap-3"
            >
    ...
    <section className="flex min-h-[calc(100vh-140px)] w-full flex-col bg-[var(--paper)]">
      ...
      <div className="border-b hairline px-4 py-16 text-center md:px-8 md:py-20">
        <div className="mx-auto max-w-3xl">
          <div className="mx-auto grid size-14 place-items-center rounded-full bg-[var(--ink)]">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-2">
            <Link
              href="/shop"
              className="focus-ring group inline-flex items-center gap-2 rounded-full bg-[var(--ink)] px-6 py-3.5 text-[10px] font-semibold uppercase tracking-[0.08em] !text-white transition-all hover:gap-3"
            >
              <span>Continue shopping</span>
