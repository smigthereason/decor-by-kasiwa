...
export const shipment = defineType({
  ...
  fields: [
    ...
    defineField({ name: "dispatchedAt", title: "Dispatched At", type: "datetime" }),
    defineField({ name: "dispatchedBy", title: "Dispatched By", type: "reference", to: [{ type: "customerUser" }] }),
    defineField({ name: "dispatchedByName", title: "Dispatched By Name", type: "string" }),
    defineField({ name: "deliveredAt", title: "Delivered At", type: "datetime" }),
    defineField({ name: "deliveredBy", title: "Delivery Confirmed By", type: "reference", to: [{ type: "customerUser" }] }),
    defineField({ name: "deliveredByName", title: "Delivery Confirmed By Name", type: "string" }),
    defineField({ name: "deliveryConfirmationNote", title: "Delivery Confirmation Note", type: "text", rows: 3 }),
