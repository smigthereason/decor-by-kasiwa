...
export default function AdminCustomersPage() {
  ...
  const filtered = customers.filter((customer) => {
    ...
    return [customer.name, customer.email, customer.location].some((value) => value.toLowerCase().includes(term));
  });
