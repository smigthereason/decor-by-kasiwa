...
export default function CheckoutPage() {
  ...
  const { hydrated, catalogueReady, catalogueError, cart, subtotal, user, createOrder, getProductById } = useCommerce();
  ...
  function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      setError("Your bag changed while checking availability. Please review it and try again.");
    }
  }
