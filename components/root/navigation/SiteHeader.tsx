    ...
    <>
          ...
          <div className="grid h-[72px] grid-cols-[1fr_auto_1fr] items-center border-b border-charcoal/[0.045] px-4 sm:h-[90px] sm:px-5 lg:px-7">
            ...
            <div className="flex min-w-0 items-center gap-3">
              <button
                ...
                className="group inline-flex h-9 shrink-0 items-center gap-1.5 rounded-full px-0.5 text-[11px] font-medium text-[var(--charcoal)] transition-opacity hover:opacity-55 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-charcoal/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--warm-beige)]"
              >
                <Menu
                  size={24}
                  strokeWidth={1.45}
              ...
              <form
                ...
                className="hidden h-[34px] items-center rounded-full bg-[var(--soft-cream)] pl-3 pr-3 sm:flex"
              >
                <input
                  value={search}
                  onChange={(event) => setSearch(event.target.value)}
                  className="w-32 bg-transparent pr-2 text-[8px] font-medium  tracking-[-0.01em] text-[var(--charcoal)] outline-none placeholder:text-charcoal/35 lg:w-48"
                ...
                <button
                  type="submit"
                  className="grid size-7 shrink-0 place-items-center rounded-full bg-[var(--deep-green)] text-soft-cream transition-transform duration-200 hover:scale-[0.96] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-charcoal/25"
            ...
            <Link
              ...
              className="relative z-20 flex items-center justify-center focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-charcoal/35 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--warm-beige)]"
            >
              <Image
                src={Logo}
            ...
            <div className="flex items-center justify-end gap-1.5">
              <Link
                ...
                className="hidden h-10 items-center gap-2 rounded-full bg-[var(--soft-cream)] pl-3 pr-1.5 text-[10px] font-medium transition-opacity hover:opacity-70 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-charcoal/35 sm:inline-flex"
              >
              ...
              <Link
                ...
                className="relative grid size-10 place-items-center rounded-full bg-[var(--soft-cream)] transition-transform duration-200 hover:scale-[0.96] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-charcoal/35"
              >
                <Heart size={20} strokeWidth={1.45} />

                {wishlist.length > 0 && (
                  <span className="absolute -right-2 -top-0.5 grid min-h-[15px] min-w-[15px] place-items-center rounded-full bg-[var(--deep-green)] px-1 text-[10px] font-semibold leading-none text-soft-cream">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            id="site-menu"
            className="fixed inset-0 z-[60] overflow-y-auto bg-[var(--deep-green)] text-[var(--paper)]"
            initial={{
              y: "-100%",
            }}
            animate={{
            ...
            <div className="flex min-h-screen w-full flex-col px-4 pb-10 pt-5 md:px-8">
              ...
              <div className="flex items-center justify-between pb-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-soft-cream/20 px-3 py-2 text-[10px] uppercase tracking-[0.08em] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-soft-cream/60"
              ...
              <div className="mt-10 grid gap-6 border-t border-(--paper) hairline pt-5 text-xs text-soft-cream/55 sm:grid-cols-[1fr_auto] sm:items-end">
                <p className="max-w-md leading-relaxed">
                  Interior design, décor and transformation for spaces that feel
                  considered, personal and complete.
                </p>

                <div className="flex flex-wrap gap-x-5 gap-y-3 text-[10px] uppercase tracking-[0.08em] text-soft-cream">
