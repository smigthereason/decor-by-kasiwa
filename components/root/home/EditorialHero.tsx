...
//             <div className="absolute inset-x-3 bottom-3 flex items-end justify-between gap-3 text-soft-cream">
...
//                   {slide.label}
//                 </span>
//                 <span className="h-px w-5 bg-[var(--deep-green)]/25" />
...
//                     selected
//                       ? "size-2 bg-[var(--deep-green)]"
//                       : "size-1.5 bg-[var(--deep-green)]/20 hover:bg-[var(--deep-green)]/45",
//                   ].join(" ")}
//                 />
//               </button>
//             );
...
//   return (
//     <section
//       className="w-full overflow-hidden bg-[var(--soft-cream)] text-[var(--charcoal)]"
//       aria-roledescription="carousel"
//       aria-label="Decor by Kasiwa featured interiors"
//       onMouseEnter={() => setPaused(true)}
//       onMouseLeave={() => setPaused(false)}
...
//                   <span className="shrink-0 text-[8px] font-semibold uppercase tracking-[0.16em] text-charcoal/50 sm:text-[9px]">
//                     {slide.meta}
//                   </span>
//                   <span className="h-px w-8 shrink-0 bg-charcoal/20" />
//                   <span className="text-[8px] uppercase tracking-[0.12em] text-charcoal/45 sm:text-[9px]">
//                     {slide.eyebrow}
//                   </span>
//                 </div>
...
//                 <p className="mt-6 max-w-[520px] text-[12px] leading-[1.7] text-charcoal/55 sm:text-[13px]">
//                   {slide.description}
//                 </p>
...
//                   <Link
//                     href="/shop"
//                     className="group inline-flex h-12 items-center justify-center gap-3 bg-[var(--charcoal)] px-6 text-[9px] font-semibold uppercase tracking-[0.13em] text-soft-cream transition-colors hover:bg-charcoal/80 sm:text-[10px]"
//                   >
//                     Shop collection
//                     <ArrowUpRight
//                       size={14}
...
//                   <Link
//                     href="/consultation"
//                     className="inline-flex h-12 items-center justify-center border border-charcoal/10 bg-transparent px-5 text-[9px] font-semibold uppercase tracking-[0.13em] text-charcoal/65 transition-colors hover:border-charcoal/25 hover:text-charcoal sm:text-[10px]"
//                   >
//                     Start a project
//                   </Link>
//                 </div>
...
//                 {/* BENEFITS                                                  */}
//                 {/* -------------------------------------------------------- */}
//                 <div className="mt-10 grid max-w-[560px] grid-cols-1 border-y border-charcoal/[0.07] sm:grid-cols-3">
//                   <div className="flex h-14 items-center gap-2 border-b border-charcoal/[0.07] text-[9px] font-medium text-charcoal/58 sm:border-b-0 sm:border-r sm:border-charcoal/[0.07]">
//                     <Truck size={14} strokeWidth={1.4} />
//                     <span>Delivery support</span>
//                   </div>

//                   <div className="flex h-14 items-center gap-2 border-b border-charcoal/[0.07] text-[9px] font-medium text-charcoal/58 sm:border-b-0 sm:border-r sm:border-charcoal/[0.07] sm:px-4">
//                     <Sparkles size={14} strokeWidth={1.4} />
//                     <span>Curated selection</span>
//                   </div>

//                   <div className="flex h-14 items-center gap-2 text-[9px] font-medium text-charcoal/58 sm:pl-4">
...
//             {/* -------------------------------------------------------------- */}
//             <div className="relative col-span-7 row-span-6 overflow-hidden bg-[var(--warm-beige)]">
//               <AnimatePresence initial={false}>
//                 <motion.div
//                   key={`feature-${active}`}
//                   className="absolute inset-0"
...
//                 <span className="bg-soft-cream px-2 py-1 text-[7px] font-semibold uppercase tracking-[0.12em] text-charcoal sm:text-[8px]">
//                   {slide.accent}
//                 </span>
...
//                   className="grid size-8 place-items-center rounded-full bg-soft-cream/95 text-charcoal transition-transform hover:rotate-45"
//                 >
//                   <ArrowUpRight size={13} strokeWidth={1.5} />
//                 </Link>
//               </div>

//               <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-charcoal/55 via-charcoal/10 to-transparent p-3 pt-12 text-soft-cream sm:p-4">
//                 <p className="text-[7px] uppercase tracking-[0.14em] text-soft-cream/65 sm:text-[8px]">
//                   Featured selection
//                 </p>
...
//             {/* -------------------------------------------------------------- */}
//             <div className="relative col-span-5 row-span-5 overflow-hidden bg-[var(--charcoal)]">
//               <AnimatePresence initial={false}>
//                 <motion.div
//                   key={`detail-${active}`}
//                   className="absolute inset-0"
...
//               <div className="absolute inset-x-0 bottom-0 p-3 text-soft-cream sm:p-4">
//                 <p className="text-[7px] uppercase tracking-[0.14em] text-soft-cream/60 sm:text-[8px]">
//                   Personal service
//                 </p>
...
//             {/* -------------------------------------------------------------- */}
//             <div className="relative col-span-8 row-span-6 row-start-7 overflow-hidden bg-[var(--warm-beige)]">
//               <AnimatePresence initial={false}>
//                 <motion.div
//                   key={`main-${active}`}
//                   className="absolute inset-0"
...
//               <div className="absolute inset-x-0 bottom-0 flex items-end justify-between bg-gradient-to-t from-charcoal/45 via-transparent to-transparent p-3 pt-14 text-soft-cream sm:p-4">
//                 <div>
//                   <p className="text-[7px] uppercase tracking-[0.14em] text-soft-cream/60 sm:text-[8px]">
//                     Decor by Kasiwa
//                   </p>
...
//                   className="grid size-8 place-items-center rounded-full bg-soft-cream text-charcoal"
//                 >
//                   <ArrowUpRight size={13} strokeWidth={1.5} />
//                 </Link>
//               </div>
...
//             {/* -------------------------------------------------------------- */}
//             <div className="col-span-4 row-span-7 row-start-6 flex flex-col justify-between bg-soft-cream p-3 shadow-[0_12px_35px_rgba(0,0,0,0.045)] sm:p-4">
//               <div>
//                 <p className="text-[7px] font-semibold uppercase tracking-[0.14em] text-charcoal/40 sm:text-[8px]">
//                   Kasiwa community
//                 </p>
...
//                 <p className="mt-2 max-w-[130px] text-[8px] leading-[1.45] text-charcoal/45 sm:text-[9px]">
//                   considered spaces, objects and interior moments.
//                 </p>
//               </div>

//               <div className="border-t border-charcoal/[0.07] pt-3">
//                 <div className="flex -space-x-2">
//                   <span className="grid size-7 place-items-center rounded-full border-2 border-soft-cream bg-[var(--warm-beige)] text-[8px] font-semibold">
//                     K
//                   </span>
//                   <span className="grid size-7 place-items-center rounded-full border-2 border-soft-cream bg-[var(--sage-green)] text-[8px] font-semibold">
//                     D
//                   </span>
//                   <span className="grid size-7 place-items-center rounded-full border-2 border-soft-cream bg-[var(--soft-cream)] text-[8px] font-semibold">
//                     +
//                   </span>
//                 </div>

//                 <p className="mt-2 text-[7px] uppercase tracking-[0.12em] text-charcoal/35 sm:text-[8px]">
...
//         {/* ================================================================ */}
//         <div className="grid grid-cols-[1fr_auto] items-center border-t border-charcoal/[0.07] pt-5">
//           <div
...
//                       selected
//                         ? "w-10 bg-charcoal"
//                         : "w-4 bg-charcoal/20 group-hover:bg-charcoal/50",
//                     ].join(" ")}
//                   />
//                 </button>
//               );
...
//               onClick={goPrevious}
//               aria-label="Previous hero slide"
//               className="grid size-10 place-items-center rounded-full border border-charcoal/10 bg-soft-cream transition-colors hover:border-charcoal/30 hover:bg-charcoal hover:text-soft-cream"
//             >
