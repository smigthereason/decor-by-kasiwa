            ...
            <aside className="p-4 md:p-8 lg:sticky lg:top-[80px]">
              ...
              <div className="mt-4 grid gap-2">
                <button
                  type="button"
                  onClick={handleAdd}
                  className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[var(--ink)] px-5 text-[10px] font-semibold uppercase tracking-[0.08em] !text-white hover:opacity-95"
                >
                  {added ? (
                    <>
                    ...
                    <>Add to bag <ArrowRight size={14} className="text-white" /></>
                  )}
                </button>
                ...
                <button
                  ...
                  disabled={buyingNow}
                  className="focus-ring inline-flex min-h-12 items-center justify-center gap-2 rounded-full border-2 border-[var(--ink)] px-5 text-[10px] font-semibold uppercase tracking-[0.08em] text-[var(--ink)] transition-all hover:bg-[var(--ink)] hover:text-[var(--paper)] disabled:opacity-50"
                >
                  {buyingNow ? (
                    <>
