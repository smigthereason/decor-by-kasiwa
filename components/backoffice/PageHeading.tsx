...
//             <h1 className="text-[8px] font-semibold uppercase tracking-[0.16em] text-[var(--muted)]">
//               {eyebrow}
//             </h1>
...
//   );
// }
// components/backoffice/PageHeading.tsx
import type { ReactNode } from "react";
...
export default function PageHeading({
  ...
  return (
    <div className="border-b hairline bg-[var(--paper)] px-4 py-8 sm:px-6 md:px-8 lg:px-9 lg:py-10">
      <p className="kicker text-[var(--muted)]">{eyebrow}</p>
      <h1 className="mt-3 text-3xl font-medium leading-[0.95] tracking-[-0.05em] sm:text-4xl lg:text-5xl">
        {title}
      </h1>
      {body && (
